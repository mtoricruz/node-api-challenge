...
The API can return a res.status(200/201) along with a message that displays inside .json().

- [x] How can we partition our application into sub-applications?

We partition our application into sub apps by taking advantage of different router files for different databases.
